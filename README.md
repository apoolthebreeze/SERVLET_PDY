...
## 11월 1일: 세션 및 장바구니 기능 추가 (연습문제-소스코드 수정완료)
...
## 11월 8일: 주문처리 페이지 추가, (구현문제- 배송일 당일(x), 국가명 SELECT박스, 우편번호&주소 검색입력 완료)
...
### - 배송 정보
![jsp-main--sfgdd run goorm site_order_order_info jsp_cartId=57035D75D28B74399BC5DEA9B190C30C](https://github.com/apoolthebreeze/SERVLET_PDY/assets/112855245/86b3253b-0e71-415e-8eb2-d6f5d96faa07)
...
### - 주문완료 페이지
![jsp-main--sfgdd run goorm site_order_order_end jsp](https://github.com/apoolthebreeze/SERVLET_PDY/assets/112855245/1280d3b1-d4a3-47e9-b7f7-143a71832e04)
...
## 11월 15일: 상품관리 페이지 추가, MYSQL 데이터 베이스 설정, JDBC 연동 (연습문제- 상품 리스트 데이터 추가/수정, 관리자 패스워드 변경, 소스코드 패스워드 변경 완료) 
...
## 11월 22일: 관리자 모드 로그인 수정 완료, footer 수정, 멤버로그인 수정. 상품 수정/삭제 페이지 추가(구현 문제-관리자 모드 삭제 기능 구현, 상품편집 완료)
...
## 11월 29일: 게시판 추가(구현 문제-회원가입 기능 만들기, 관리자 모드 회원 보기/수정/삭제 페이지 만들기 완료)
