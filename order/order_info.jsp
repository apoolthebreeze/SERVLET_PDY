...
<head>
    ...
    <script type="text/javascript">
        function checkDateInput() {
            const dateInput = document.getElementsByName("shippingDate")[0];
            const today = new Date();
            today.setHours(0, 0, 0, 0);
            if (new Date(dateInput.value) <= today + 1) {
                alert("배송일은 내일 이후로 설정해야 합니다. 당일은 안됩니다.");
                dateInput.value = '';
            }
        }
        ...
        function searchAddress() {
            new daum.Postcode({
                oncomplete: function(data) {
                    ...
                    const addressNameInput = document.getElementsByName("addressName")[0];
                    zipCodeInput.value = data.zonecode;
                    addressNameInput.value = data.address;
                }
            }).open();
        }
    </script>
    ...
    <div class="container">
        <form action="order_info_process.jsp" class="form-horizontal" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input name="shippingDate" type="date" class="form-control" min="<%= java.time.LocalDate.now().plusDays(1) %>" />
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label class="col-sm-2">우편번호</label>
                <div class="col-sm-3">
                    <input name="zipCode" type="text" class="form-control" placeholder="우편번호"/>
                </div>
                <div class="col-sm-2">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input name="addressName" type="text" class="form-control" placeholder="주소" />
                </div>
                <div class="col-sm-2">
