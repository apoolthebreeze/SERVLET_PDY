...
<div class="card bg-white text-brown">
    <img src="image/hotbanner.png" class="card-img" alt="..." width="2000" height="300">
    <div class="card-img-overlay">
        <h5 class="card-title" style="color: white; padding: 5px;">인싸템은 여기! 트렌디한 인기 이모티콘</h5>
        <p class="card-text" style="color: white; padding: 3px;">출처: 카카오 이모티콘샵</p>
    </div>
</div>
<br><br>
<%! String greeting = "인기 이모티콘";
        String tagline = "하단 페이지: 확인";%>
<div class="container">
    <div class="jumbotron" style="background-color: #70EEFF; padding: 5px;">
        <div class="container">
            <h3 class="display-4 text-center" style="background-color: #70EEFF; padding: 5px;">
                <%=greeting%>
            </h3>
        </div>
    </div>
